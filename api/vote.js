...
module.exports = function (data) {
  try {
    ...
    if (discordids.includes(data.authUserID)) return data.res.sendStatus(418) && server.bot.fetchUser("183249892712513536").then(user => user.send(`<@${data.authUserID}> tried to vote for themselves and got rolled! <a:rolled:639351719242891264>`));
